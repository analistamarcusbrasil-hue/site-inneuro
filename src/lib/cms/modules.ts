...
export const cmsModules: CmsModule[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      {
        name: "use_general_schedule",
        label: "Usar horários gerais do site",
        type: "checkbox",
        help: "Recomendado. Usa automaticamente os dias e períodos definidos em Horários dos exames.",
        location: "Cards e página do preparo.",
      },
      {
        name: "override_days_text",
        label: "Exceção de dias",
        type: "textarea",
        help: "Preencha somente se esta modalidade tiver dias diferentes, confirmados pela INNEURO. Um dia por linha.",
        example: "sábado\ndomingo",
      ...
      },
      {
        ...
        label: "Exceção de períodos",
        type: "textarea",
        help: "Preencha somente se esta modalidade tiver períodos diferentes. Um período por linha.",
        example: "manhã\ntarde",
        location: "Página do preparo.",
        maxLength: 300,
      },
      {
        name: "schedule_note",
        label: "Observação sobre disponibilidade",
        type: "textarea",
        help: "Use somente para uma regra específica confirmada desta modalidade.",
        location: "Página do preparo.",
        maxLength: 500,
      },
      {
        name: "schedules_text",
        label: "Faixas específicas confirmadas",
        type: "textarea",
        help: "Deixe vazio ao usar a configuração geral. Para exceções: Rótulo | Dias | início-fim.",
        example:
          "Use a configuração geral em Horários dos exames. Preencha somente se houver exceção confirmada.",
